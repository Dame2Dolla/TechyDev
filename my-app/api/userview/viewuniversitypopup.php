...
$stmt = $conn->prepare("SELECT edu.education_ID, edu.institutionName, edu.courseTitle, edu.date_start, edu.date_end, edu.is_ongoing FROM tbl_Users us JOIN tbl_Users_Educations usedu ON us.user_ID = usedu.user_ID_pk_fk JOIN tbl_Educations edu ON edu.education_ID = usedu.education_ID_pk_fk WHERE us.user_ID = ? ORDER BY edu.is_ongoing DESC, edu.date_end DESC;");
